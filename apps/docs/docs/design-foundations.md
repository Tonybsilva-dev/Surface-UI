...
- **Navigation bar:** ideal para **3–5 destinos** de importância similar; manter os mesmos destinos entre telas quando possível.
...
- O sistema usa **window size classes** (largura/altura) para decidir layouts:

...
/** Visão geral: princípios de shape no M3 */
export const shapeOverview = {
  title: "Shape",
  description:
    "O sistema de shape do M3 inclui formas originais, uma escala de corner radius e morphing de formas. Componentes usam essa escala para definir retângulos como botões, cards e diálogos.",
  principles: [
  ...
  link: "https://m3.material.io/styles/shape/overview-principles",
} as const;

/** Escala de corner radius e aplicação */
export const shapeCornerRadiusScale = {
  description:
    "O M3 usa uma escala baseada em tamanho com vários níveis (None 0dp, Extra small 4dp, Small 8dp, Medium 12dp, Large 16dp, até Full). Estilos são atribuídos aos componentes conforme a quantidade de arredondamento desejada.",
  scale: [
    "None – 0dp",
    "Extra small – 4dp",
    "Small – 8dp",
  ...
  link: "https://m3.material.io/styles/shape/corner-radius-scale",
} as const;

/** Shape morph: transição entre formas */
export const shapeMorph = {
  description:
    "O M3 oferece morphing de formas: transições animadas entre um shape e outro (ex.: FAB que vira barra, chip que expande). Use com os tokens de motion para duração e easing consistentes.",
  whenToUse: [
  ...
  link: "https://m3.material.io/styles/shape/shape-morph",
} as const;
